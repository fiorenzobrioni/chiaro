...
enum class WmoCode(
    ...
    RIME_FOG(48, ConditionWord.FOG, Phase.NONE, 11, null),
     ...
     * ground whatever the amount; snow, snow grains and snow showers are [FROZEN].
     */
    enum class Phase { NONE, LIQUID, FREEZING, FROZEN }

    val isPrecipitation: Boolean get() = phase != Phase.NONE
    val isFog: Boolean get() = word == ConditionWord.FOG
