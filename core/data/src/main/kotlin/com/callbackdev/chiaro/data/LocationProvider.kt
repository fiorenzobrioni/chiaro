...
interface LocationProvider {
     ...
     *
     * [maxAge] is the whole battery contract (Fase 3b). A position the system already
...
class AndroidLocationProvider(private val context: Context) : LocationProvider {
     ...
     * on real movement — and since Fase 3b the geocoder is asked with the rounded
     * pair too: it is a network service on most devices, and handing it the most
     * precise coordinate the app owns while rounding everything else was the one
     * place where the privacy rule leaked.
     */
