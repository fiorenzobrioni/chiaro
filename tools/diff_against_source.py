...
la scala**: i set spediti portano il gruppo `mc3scale` che li riporta tutti a una misura
comune (DESIGN §13.1), e confrontare quelli con la sorgente misurerebbe la
